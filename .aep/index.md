...
| [[efforts/7-document-downloads-and-contact-details/tickets/01-content-contract]] feat(content): a nationality on the profile, Mudaraj on the resume, and the email recorded as unrendered | 7-document-downloads-and-contact-details | open | — |
| [[efforts/7-document-downloads-and-contact-details/tickets/02-contact-details-out]] feat(site): the contact line without an email, and the email out of every other output | 7-document-downloads-and-contact-details | open | 01 |
| [[efforts/7-document-downloads-and-contact-details/tickets/03-one-download-icon]] feat(cv): one download icon per document page, in place of the actions row | 7-document-downloads-and-contact-details | open | — |
| [[efforts/7-document-downloads-and-contact-details/tickets/04-form-and-print]] feat(cv): the form that fills the contact line, and the print that generates the document | 7-document-downloads-and-contact-details | open | 02, 03 |
| [[efforts/7-document-downloads-and-contact-details/tickets/05-the-checks]] test(cv): no published file carries a contact detail, and the generated document extracts | 7-document-downloads-and-contact-details | open | 04 |
